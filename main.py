...
def login_window():
    ...
    bg_image = tk.PhotoImage(
        file='D:\Python-Projects\ATM_Simulator\Images\image_bg.png')
    ...
    card_image = tk.PhotoImage(
        file='D:\Python-Projects\ATM_Simulator\Images\image_card.png')
    ...
    pin_image = tk.PhotoImage(
        file='D:\Python-Projects\ATM_Simulator\Images\image_pin.png')
...
def show_balance(user):
    ...
    money_image = tk.PhotoImage(
        file='D:\Python-Projects\ATM_Simulator\Images\image_money.png')
